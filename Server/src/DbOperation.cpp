#include"../inc/DbOperation.h"
   ...
   DatabaseRepository:: ~DatabaseRepository() {
    ...
    sql::ResultSet* DatabaseRepository::selectAll(const std::string& entityName, const std::map<std::string, std::string>& filter , const std::map<std::string, std::string>& orderBy , const std::string& condition ) const {
        ensureInitialized();
